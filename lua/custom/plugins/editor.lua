return {
...

  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>a", function() harpoon:list():append() end, { desc = "Harpoon Attach" })
      ...
      vim.keymap.set("n", "<C-S-P>", function() harpoon:list():prev() end, { desc = "Harpoon Next Target" })
      vim.keymap.set("n", "<C-S-N>", function() harpoon:list():next() end, { desc = "Harpoon Previous Target" })
    end,
  },
...

  {
    "folke/zen-mode.nvim",
    keys = {
      { "<leader>tz", function() require("zen-mode").toggle() end, desc = "Toggle Zenmode" },
    },
    opts = {
      plugins = {
        kitty = {
